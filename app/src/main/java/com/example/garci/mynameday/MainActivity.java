...
public class MainActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener
{
    ...
    public void onDateSet(DatePicker view, int year, int month, int day)
    {
        ...
        if (dayOfWeek == 0) { dayOfTheWeek = "Saturday"; }

        else if (dayOfWeek == 1) { dayOfTheWeek = "Sunday"; }

        else if (dayOfWeek == 2) { dayOfTheWeek = "Monday"; }

        else if (dayOfWeek == 3) { dayOfTheWeek = "Tuesday"; }

        else if (dayOfWeek == 4) { dayOfTheWeek = "Wednesday"; }

        else if (dayOfWeek == 5) { dayOfTheWeek = "Thursday"; }

        else if (dayOfWeek == 6) { dayOfTheWeek = "Friday"; }

        else { dayOfTheWeek = "Error computing day of week..."; }
    ...
    private class ConnectToSite extends AsyncTask<Integer, Integer, String[]>
    {
        ...
        protected void onPostExecute(String[] result)
        {
            ...
            ((TextView) findViewById(R.id.celebrity_birthdate_matches)).setText("Celebrities with the same birthday:\n\n" + listOfCelebrities);
        }
    }
}
